...
async def index_files(bot, query):
    ...
    if raju == 'reject':
        ...
        await bot.send_message(int(from_user),
                               f'Your Submission for indexing {chat} has been decliened by my Creator.',
    ...
    if int(from_user) not in ADMINS:
        await bot.send_message(int(from_user),
                               f'Your Submission for indexing {chat} has been accepted by @OO7ROBot and will be added soon.',
                               reply_to_message_id=int(lst_msg_id))
    await msg.edit(
        "Starting Indexing",
...
async def send_for_index(bot, message):
    ...
    await bot.send_message(LOG_CHANNEL,
                           ...
                           reply_markup=reply_markup)
    await message.reply('ThankYou For the Contribution, Wait For @OO7ROBot to verify the files.')
